...
<div class="page-content">
    ...
    <div class="row">
    	<div class="col-md-12" style="margin-bottom:10px;">
        	<a class="pull-right button normals btn-circle" id="get_pcb_email">Email This Report</a>
        </div>
    </div>
...
<script src="<?php echo base_url(); ?>assets/feedback/js/chart.js" type="text/javascript"></script>
...
var startDate;
  ...
  $('.weekTxt').datepicker({showOtherMonths: false,});
  /*  $('.weekTxt').datepicker( {
