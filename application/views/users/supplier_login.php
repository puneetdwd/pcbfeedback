                ...
                <div class="container">
                    ...
                    <div id="utils">
                        ...
                        <form class="form navbar-form" role="form" method="post" action="supplier_login" accept-charset="UTF-8" id="login-nav">
                            ...
                            <div class="text-left">
                                <div class="form-group">
                                <label for="sup_user_type" style="vertical-align: sub;">Admin</label>
                                <input type="radio" class="form-control input-sm" name="sup_user_type" value="Supplier" checked="checked" required>
                            </div> &nbsp;&nbsp;&nbsp;&nbsp;
                            <div class="form-group">
                                <label for="sup_user_type" style="vertical-align: sub;">Inspector</label>
                                <input type="radio" class="form-control input-sm" name="sup_user_type" value="Inspector" required>
                            </div>&nbsp;&nbsp;&nbsp;&nbsp;
                           <!-- <div class="form-group">
                                <label for="sup_user_type" style="vertical-align: sub;">PCB Feedback</label>
                                <input type="radio" class="form-control input-sm" name="sup_user_type" value="PCB" required>
                            </div>-->
