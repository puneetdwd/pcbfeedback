<div class="page-content">
    ...
    <div class="breadcrumbs">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Upload Fool Proof Checkpoints</li>
        </ol>
        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="portlet light bordered inspection-add-form-portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i> Upload Fool Proof Checkpoints Form
                    </div>
                    <div class="actions">
                        <a target="_blank" class="button normals btn-circle" href="<?php echo base_url()."assets/formats/Foolproof_Checkpoints.xlsx"; ?>">
                    ...
                    <form role="form" class="validate-form" method="post" enctype="multipart/form-data">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="checkpoints_excel" class="control-label">Upload Fool Proof Checkpoints:
