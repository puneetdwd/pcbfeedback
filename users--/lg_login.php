                ...
                <div class="container">
                    ...
                    <div id="utils">
                        ...
                        <form class="form navbar-form" role="form" method="post" action="supplier_login" accept-charset="UTF-8" id="login-nav">
                            ...
                            <div class="text-left">
                                <div class="form-group"> 
                                <label for="lg_admin_user_type" style="vertical-align: sub;">Admin</label>
                                <input type="radio" class="form-control input-sm" name="lg_admin_user_type" value="LGADMIN" checked="checked" required>
                            </div> &nbsp;&nbsp;&nbsp;&nbsp;
                            <div class="form-group">
                                <label for="lg_user_type" style="vertical-align: sub;">LG User</label>
                                <input type="radio" class="form-control input-sm" name="lg_user_type" value="LGUSER" required>
                            </div>&nbsp;&nbsp;&nbsp;&nbsp;
                            <div class="form-group">
                                <label for="repair_user_type" style="vertical-align: sub;">LG Repair User</label>
                                <input type="radio" class="form-control input-sm" name="repair_user_type" value="LGREPAIR" required>
                            </div>
