...
$(function() {
    var db = {
        ...
        //  alert ( console.log(this.filter));
			var clientDataArray=new Array();
			var clientDataArray2=new Array();
			$.ajax({
						url: base_url+"masters/get_all_repair_data/", 
						type: "POST",
						dataType:"json",
						cache:false,
						async:false,
        ...
        updateItem: function(updatingClient) {
			...
			$.ajax({
					   url: base_url+"masters/lg_repair_save_data", 
					   type: "POST",
    ...
    var db1 = {
        ...
        loadData: function(filter) {
           // console.log(this.clients);
			...
			var clientDataArray2=new Array();
			$.ajax({
						url: base_url+"suppliers/get_selected_lg_user_data", 
						type: "POST",
						dataType:"json",
						cache:false,
						async:false,
